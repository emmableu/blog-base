...
// markdown-it-latex2img is the only solution that works, see this github issue:https://github.com/emmableu/vuepress-theme-vdoing/issues/513
import markdownItLatex from "markdown-it-latex2img"

const DOMAIN_NAME = 'emmableu.github.io/blog' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    //*** 以下是Vdoing主题相关配置，文档：https://doc.emmableu.com/pages/a20ce8/ ***//
    ...
    bodyBgImg: [
      // 'https://cdn.jsdelivr.net/gh/emmableu/image_store/blog/20200507175828.jpeg',
      'https://cdn.jsdelivr.net/gh/emmableu/image_store/blog/20200507175845.jpeg',
      // 'https://cdn.jsdelivr.net/gh/emmableu/image_store/blog/20200507175846.jpeg'
    ...
    // 社交图标 (显示于博主信息栏和页脚栏。内置图标：https://doc.emmableu.com/pages/a20ce8/#social)

    // 页脚信息
    footer: {
      createYear: 2022, // 博客创建年份
      copyrightInfo:
        'emmableu | <a href="https://github.com/emmableu/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签或换行标签</br>
    },
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        ...
        options: {
          ...
          owner: 'emmableu', // GitHub仓库所有者
          admin: ['emmableu'], // 对仓库有写权限的人
