...
I went to NC State first for a master's degree in stats, 
- where I've learned basic statistical tests, linear models, etc

I wanted to learn more about machine learning and especially explore how they are actually applied or being used in the real world, so I did a PHD in CS. I chose an advisor who does ML in human-computer interaction. because
- I like ml
- I like HCI - building things that can be used by real people (my passion)

Although, in the end I found that my thesis project - also the grant I'm funded on - it's a problem that can essentially be more elegantly solved with a traditional, program analysis, (code analysis, static/dynamic analysis) approach, so I did not end up applying lots of ML in my PhD degree - only a little bit, in the first 2 projects/papers that I've published in my phd career. 
