...
::: warning
如果你正在寻找本博客的搭建文档，博主建议您查看这个仓库的[README](https://github.com/emmableu/vuepress-theme-vdoing)。
:::
...
> git 操作部分和使用github的差不多，不了解git操作的可以看我的另一篇文章：[Git使用手册](https://emmableu.com/pages/9a7ee40fc232253e/)
...
# github
echo 'b.emmableu.com' > CNAME
git init
git add -A
git commit -m 'deploy'
git push -f git@github.com:emmableu/blog.git master:gh-pages # 发布到github

# coding
echo 'emmableu.com' > CNAME
git add -A
git commit -m 'deploy'
git push -f git@git.dev.tencent.com:emmableu/emmableu.git master # 发布到coding
